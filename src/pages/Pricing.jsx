...
export default function Pricing() {
  ...
  const DEFAULT_PLANS = [
    ...
    },
    {
      ...
      description: "Designed for standard schools and academies managing grades 9 through 12.",
      priceMonthly: 4999,
      priceAnnual: 49990,
      maxStudents: 500,
      features: [
  ...
  return (
    <div className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-extrabold uppercase tracking-wider bg-sky-100 text-[#1b93ad]">
          <School className="w-3.5 h-3.5" />
          <span>Institutional Packages & Pricing</span>
        </span>
        <h1 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight">
          Empower Your Students with <span className="text-[#1b93ad]">Scientific Career Guidance</span>
        </h1>
          ...
          <button
            ...
            className={
              ...
              (billingCycle === "MONTHLY"
                ? "bg-[#1b93ad] text-white shadow-md"
          ...
          return (
            <div
              ...
              className={
                ...
                (plan.isFeatured
                  ? "bg-slate-900 text-white border-cyan-400 shadow-2xl ring-2 ring-cyan-400/40"
            ...
            >
                ...
                <span
                  className={
                    ...
                    (plan.isFeatured
                      ...
                      : "bg-sky-100 text-[#1b93ad] border border-sky-200")
                  }
                >
                  {plan.badgeText}
                </span>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-2 border-t border-slate-100/10">
                  ...
                  <div className="text-[11px] font-bold text-[#1b93ad] mt-1 flex items-center gap-1">
              ...
              <div className="pt-6 mt-4">
                <button
                  ...
                  className={
                    ...
                    (plan.isFeatured
                      ? "bg-gradient-to-r from-cyan-400 to-sky-500 hover:from-cyan-300 hover:to-sky-400 text-slate-950 font-black shadow-lg shadow-cyan-500/25"
                      : "bg-[#1b93ad] hover:bg-[#15798e] text-white")
                  }
                >
      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 sm:p-12 text-white shadow-xl space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-slate-800/80 border border-slate-700 rounded-2xl p-5 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-cyan-500/20 text-cyan-400 font-black flex items-center justify-center text-sm">
              01
            </div>
          ...
          <div className="bg-slate-800/80 border border-slate-700 rounded-2xl p-5 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-sky-500/20 text-sky-400 font-black flex items-center justify-center text-sm">
              02
            </div>
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="text-center space-y-2">
          <span className="text-xs font-extrabold uppercase tracking-wider text-[#1b93ad]">
            Frequently Asked Questions
          </span>
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full text-left px-6 py-4.5 flex items-center justify-between gap-4 font-bold text-sm text-slate-800 hover:text-[#1b93ad] cursor-pointer"
                >
