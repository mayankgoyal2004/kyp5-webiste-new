  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-3xl p-5 sm:p-6 border border-slate-200/80 shadow-xs flex flex-wrap items-center justify-between gap-4">
        <div>
          <span className="text-[10px] font-extrabold text-indigo-700 uppercase tracking-wider bg-indigo-50 border border-indigo-100 px-3 py-1 rounded-full">
            Active Assessment
          </span>
          <h2 className="text-base sm:text-xl font-black text-slate-900 mt-1.5">
            {testInfo?.title}
          </h2>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm space-y-6">
          ...
          <div className="flex items-center justify-between border-b border-slate-100 pb-4">
            <span className="text-xs font-black text-indigo-700 bg-indigo-50 border border-indigo-100 px-3.5 py-1.5 rounded-xl">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left p-4 sm:p-4.5 rounded-2xl border text-xs sm:text-sm font-semibold transition-all flex items-center justify-between cursor-pointer ${
                        isSelected ? "bg-indigo-50/90 border-indigo-600 text-indigo-950 shadow-xs ring-1 ring-indigo-600" : "bg-slate-50/60 hover:bg-slate-100/80 border-slate-200 text-slate-700"
                      }`}
                    >
